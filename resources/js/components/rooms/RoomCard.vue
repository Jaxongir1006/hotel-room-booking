...
const { targetEl, transformStyle, transitionStyle } = useThreeDTilt({
    max: 8,
    scale: 1.02,
});
</script>
...
<template>
    ...
    >
        <Link
            ...
            class="group block cursor-pointer overflow-hidden rounded-xl border border-slate-200/80 bg-white shadow-sm hover:border-[#c9a84c]/60 hover:shadow-[0_20px_50px_rgba(201,168,76,0.12)]"
        >
            <div class="relative aspect-[4/3] overflow-hidden bg-slate-100">
                ...
                <div
                    class="absolute top-3 left-3 rounded-full bg-[#1a2744]/90 px-3 py-1 text-xs tracking-widest text-[#c9a84c] uppercase backdrop-blur"
                >
                    {{ room.type_label }}
                </div>
            </div>
            ...
            <div class="space-y-3 p-5">
                ...
                >
                    ...
                    <div class="text-right">
                        <span
                            class="font-serif text-lg font-medium text-[#1a2744]"
                        >
